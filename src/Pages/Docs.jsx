        ...
        <div className="flex flex-col gap-4 w-full max-w-4xl">
          ...
          <div className="rounded-sm p-3 bg-[#1e1e1e] overflow-x-auto">
            <SyntaxHighlighter language="text" style={vscDarkPlus}>
              {`Base URL: https://restjson-server.vercel.app`}
            </SyntaxHighlighter>
          </div>
            ...
            {activeClient === "fetch" && (
              <>
                <SyntaxHighlighter language="javascript" style={vscDarkPlus}>
                  {`const res = await fetch('https://restjson-server.vercel.app/users')
...
console.log(data)`}
                ...
                <SyntaxHighlighter language="javascript" style={vscDarkPlus}>
                  {`fetch('https://restjson-server.vercel.app/users')
  .then(res => res.json())
  .then(console.log)`}
                </SyntaxHighlighter>
              </>
            ...
            {activeClient === "axiosaxiosInstance" && (
              <>
                <SyntaxHighlighter language="javascript" style={vscDarkPlus}>
                  {`const res = await axiosaxiosInstance.get('https://restjson-server.vercel.app/users')
console.log(res.data)`}
                ...
                <SyntaxHighlighter language="javascript" style={vscDarkPlus}>
                  {`axiosaxiosInstance.get('https://restjson-server.vercel.app/users')
